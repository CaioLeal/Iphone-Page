            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-2 gap-8 mb-16">
                    <div className="bg-gray-900 rounded-3xl p-8">
                        <img className="w-full rounded-2xl mb-4" src="imgs/titanium-design.jpg" alt="iphone-titanium" />
                    ...
                    <div className="bg-gray-900 rounded-3xl p-8">
                        <img className="w-full rounded-2xl mb-4" src="imgs/ios-features.jpg" alt="ios-features" />
                ...
                <div className="bg-gray-900 rounded-3xl p-12 mb-16" id="performance">
                    ...
                    <img className="w-full rounded-2xl mb-4" src="imgs/chip-a18-pro.jpg" alt="chip-a18" />
                ...
                <div className="text-center" id="camera">
                    <h3 className="txt-4xl font-bold mb-10">Sistemade câmera Pro avançado</h3>
                    ...
                    <div className="grid grid-cols-3 gap-6">
                        ...
                        <div className="bg-gray-900 rounded-2xl p-8 hover:scale-105 cursor-pointer transition-all duration-300">
                            ...
                            <p className="text-gray-400">Zoom óptico 5x com estabilização</p>
                        </div>
                    </div>
                </div>
            </div>
